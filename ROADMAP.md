...
## ЭТАП 4.5: v1.4 Корм-гид (где купить + альтернативы)

> Перед деплоем — ключевая ценность для пользователей

### Фаза 4.5A — Данные о кормах

- [ ] База данных рекомендованных кормов по странам (JSON/SQLite)
  - Россия: WB, Ozon, ветаптеки — конкретные бренды
  - Мексика: региональные магазины + бренды
  - США: Chewy, Amazon, PetSmart — бренды
  - Европа (DE/UK/ES): zooplus, Amazon и др.
  - Другие страны: generic рекомендации
- [ ] Категории кормов: влажный, сухой, лечебный, альтернативный
- [ ] Данные для каждого корма: название, БЖУ (сух. вещество), ссылка на покупку, цена-диапазон

### Фаза 4.5B — Альтернативные корма с низким содержанием углеводов

- [ ] Исследование: форумы (felinediabetes.com, catinfo.org, vet forums)
- [ ] Список "неочевидных" кормов: ProPlan Gastrointestinal, и др.
- [ ] Для каждого: БЖУ анализ, % углеводов DM, вердикт (подходит/условно/нет)
- [ ] Источники и ссылки на исследования
- [ ] Дисклеймер: "не заменяет консультацию ветеринара"

### Фаза 4.5C — UI экраны

- [ ] Экран "Где купить корм" — выбор страны → список магазинов + кормов
- [ ] Экран "Альтернативные корма" — карточки с БЖУ, вердиктом, источником
- [ ] Интеграция с калькулятором корма (переход от результата к покупке)
- [ ] Навигация: из Энциклопедии или отдельный таб/секция в More

> **CHECKPOINT 4.5**: commit + tsc + test
