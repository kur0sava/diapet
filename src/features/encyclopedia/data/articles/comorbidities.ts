...
**Когда заподозрить:**
- Доза инсулина растёт и **устойчиво превышает ~6 IU на инъекцию** несмотря на верную технику и диету, при сохраняющейся плохой компенсации — это повод заподозрить акромегалию и обследоваться (IGF-1). Ранний скрининг особенно оправдан, если доза быстро растёт без ответа (Niessen 2007, Posch 2019)
...
**When to suspect it:**
- Insulin dose climbs and **persistently exceeds ~6 IU per injection** despite correct technique and diet, with poor control — this is a reason to suspect acromegaly and test IGF-1. Early screening is especially warranted if the dose rises rapidly without response (Niessen 2007, Posch 2019)
