...
- Hill's m/d: официальных поставок в РФ больше нет (производство ушло из РФ). На «сером» рынке — цены x2-3 и без гарантии подлинности; ориентируйтесь на доступные в РФ варианты выше
