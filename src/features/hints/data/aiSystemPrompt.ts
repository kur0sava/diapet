...
${injectionSiteInfo}
- Unopened insulin is stored in the refrigerator (2–8°C). Storage after opening depends on the product and label: for example, Lantus 28 days, Levemir 42 days, ProZinc 10 mL vial 60 days (20 mL 80 days), and Caninsulin/Vetsulin 42 days with region-specific storage instructions after first use. Never freeze insulin and always follow the exact package insert for the owner's product.
