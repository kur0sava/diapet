...
export const HINTS: HintContent[] = [
  ...
  },
  {
    ...
    category: 'support',
    timeOfDay: 'evening',
    ru: 'Большинство питомцев привыкают к уколам в течение первой недели. То, что сегодня кажется сложным, через несколько дней станет просто частью дня.',
    en: 'Most pets get used to injections within the first week. What feels hard today will simply become part of your routine in a few days.',
  },
  {
    id: 'inj_w1_d3m',
    trigger: 'injection',
    ...
    timeOfDay: 'morning',
    ru: 'Инсулин всегда вводят после еды — это снижает риск гипогликемии. Если питомец отказался есть, не делай укол и сразу позвони ветеринару.',
    en: 'Insulin is always given after a meal — this lowers the risk of hypoglycemia. If your pet refused to eat, skip the injection and call your vet right away.',
  },
  {
    id: 'inj_w1_d3e',
    trigger: 'injection',
  ...
  },
  {
    ...
    category: 'support',
    timeOfDay: 'morning',
    ru: 'Если питомец нервничает перед уколом, попробуй сделать его во время кормления — большинство животных настолько увлечены едой, что почти не реагируют.',
    en: 'If your pet gets anxious before injections, try giving the shot during feeding time — most pets are so focused on food they barely notice.',
  },
  {
    id: 'inj_w1_d4e',
    trigger: 'injection',
  ...
  },
  {
    ...
    category: 'practical',
    timeOfDay: 'morning',
    ru: 'Угол введения иглы 45° подходит большинству питомцев. У худых животных можно уменьшить до 30° — меньше риска попасть в мышцу.',
    en: 'A 45° needle angle works for most pets. For lean animals, try 30° — less risk of hitting muscle.',
  },
  {
    id: 'inj_w2_d3e',
    trigger: 'injection',
  ...
  },
  {
    ...
    category: 'medical_fact',
    timeOfDay: 'morning',
    ru: 'Инсулин начинает действовать через 1–3 часа после укола. В это время лучше держать питомца в привычной обстановке без лишнего стресса.',
    en: "Insulin starts working 1–3 hours after injection. During this time, it's best to keep your pet in a calm, familiar environment.",
  },
  {
    id: 'inj_w2_d4e',
    trigger: 'injection',
    ...
    category: 'practical',
    timeOfDay: 'evening',
    ru: 'Если питомец начал вырываться во время уколов — попробуй сделать его, пока он стоит или сидит естественно, без фиксации. Иногда меньше сдерживания означает меньше стресса.',
    en: "If your pet has started wriggling during injections, try giving the shot while they're standing or sitting naturally, without restraint. Sometimes less holding means less stress.",
  },
  {
    id: 'inj_w2_d5m',
    trigger: 'injection',
  ...
  },
  {
    ...
    category: 'medical_fact',
    timeOfDay: 'evening',
    ru: 'Стресс — как у питомца, так и у хозяина — может влиять на уровень глюкозы. Спокойное состояние перед уколом помогает обоим.',
    en: 'Stress — for both the pet and the owner — can affect glucose levels. A calm moment before the injection helps you both.',
  },
  {
    id: 'inj_w2_d6m',
    trigger: 'injection',
...

  {
    ...
    category: 'medical_fact',
    timeOfDay: 'morning',
    ru: 'Обрати внимание: если питомец стал более активным и меньше пьёт воды — это хороший знак. Глюкоза начинает контролироваться.',
    en: "Pay attention: if your pet has become more active and is drinking less water — that's a good sign. Glucose is starting to come under control.",
  },
  {
    id: 'inj_w3_d1e',
    trigger: 'injection',
  ...
  },
  {
    ...
    category: 'support',
    timeOfDay: 'morning',
    ru: 'Три недели — это серьёзный срок. Ты уже видишь своего питомца иначе: не как пациента, а как партнёра в этом маршруте.',
    en: "Three weeks is significant. You're already seeing your pet differently — not as a patient, but as a partner in this journey.",
  },
  {
    id: 'inj_w3_d2e',
    trigger: 'injection',
    ...
    category: 'practical',
    timeOfDay: 'evening',
    ru: 'Хорошая практика: подготовь шприц за 5 минут до укола, пока питомец ест. Так ты не торопишься и не нервничаешь.',
    en: 'Good habit: prepare the syringe 5 minutes before the injection, while your pet eats. No rushing, no nerves.',
  },
  {
    id: 'inj_w3_d3m',
    trigger: 'injection',
  ...
  },
  {
    ...
    category: 'support',
    timeOfDay: 'evening',
    ru: 'Иногда всё идёт не по плану — укол получился неловким, питомец вырвался. Это бывает. Один несовершенный укол ничего не сломает.',
    en: "Sometimes things don't go smoothly — an awkward injection, a wriggling pet. It happens. One imperfect shot won't break anything.",
  },
  {
    id: 'inj_w3_d4m',
    trigger: 'injection',
  ...
  },
  {
    ...
    category: 'medical_fact',
    timeOfDay: 'evening',
    ru: 'Физическая активность снижает уровень глюкозы. Если питомец играл перед уколом — это может повлиять на показания. Записывай это наблюдение.',
    en: 'Physical activity lowers glucose levels. If your pet played before the injection, that can affect readings. Log this observation.',
  },
  {
    id: 'inj_w3_d5m',
    trigger: 'injection',
  ...
  },
  {
    ...
    category: 'practical',
    timeOfDay: 'evening',
    ru: 'Не нужно дезинфицировать кожу питомца перед уколом: спирт нарушает всасывание инсулина и раздражает место инъекции, а риск инфекции при короткой подкожной инъекции минимален (ISFM). Достаточно чистых рук и свежей иглы для каждого укола.',
    en: "You don't need to disinfect your pet's skin before injecting: alcohol disrupts insulin absorption and irritates the injection site, and the infection risk from a short subcutaneous needle is minimal (ISFM guidance). Clean hands and a fresh needle for each injection are sufficient.",
  },
  {
    id: 'inj_w3_d6m',
    trigger: 'injection',
    ...
    category: 'medical_fact',
    timeOfDay: 'morning',
    ru: 'Если питомец потолстел после начала инсулинотерапии — это возможный побочный эффект. Обсуди с ветеринаром корректировку диеты и дозы.',
    en: "If your pet has gained weight since starting insulin therapy, that's a possible side effect. Discuss diet and dose adjustments with your vet.",
  },
  {
    id: 'inj_w3_d6e',
    trigger: 'injection',
    ...
    category: 'support',
    timeOfDay: 'evening',
    ru: 'Ты научился видеть питомца по-новому — замечать маленькие сигналы его самочувствия. Это навык, который мало кто имеет.',
    en: "You've learned to read your pet in a new way — noticing small signals of how they're feeling. That's a skill very few people have.",
  },
  {
    id: 'inj_w3_d7m',
    trigger: 'injection',
  ...
  },
  {
    ...
    category: 'support',
    timeOfDay: 'evening',
    ru: 'Четыре недели. Ты уже эксперт по своему питомцу — знаешь его реакции, его настроение, его паттерны. Это ценнее любых книжных знаний.',
    en: "Four weeks. You're already an expert on your pet — you know their reactions, their mood, their patterns. That's worth more than any textbook.",
  },
  {
    id: 'inj_w4_d2m',
    trigger: 'injection',
    ...
    category: 'practical',
    timeOfDay: 'morning',
    ru: 'Если ты путешествуешь, берёшь питомца с собой или оставляешь с кем-то — составь письменную инструкцию с дозой, временем и контактами ветеринара.',
    en: "If you're travelling, taking your pet along, or leaving them with someone — write a clear care sheet with the dose, timing, and your vet's contact.",
  },
  {
    id: 'inj_w4_d2e',
    trigger: 'injection',
  ...
  },
  {
    ...
    category: 'medical_fact',
    timeOfDay: 'morning',
    ru: 'Инфекции — даже незначительные — могут повысить потребность в инсулине. Если питомец заболел, чаще измеряй глюкозу и держи связь с ветеринаром.',
    en: 'Infections — even minor ones — can increase insulin needs. If your pet gets sick, check glucose more often and stay in touch with your vet.',
  },
  {
    id: 'inj_w4_d4e',
    trigger: 'injection',
  ...
  },
  {
    ...
    category: 'medical_fact',
    timeOfDay: 'evening',
    ru: 'Стероиды, некоторые антибиотики и противовоспалительные препараты могут влиять на уровень глюкозы. Всегда сообщай ветеринару обо всех лекарствах, которые принимает питомец.',
    en: 'Steroids, some antibiotics, and anti-inflammatory drugs can affect glucose levels. Always tell your vet about every medication your pet is taking.',
  },
  {
    id: 'inj_w4_d6m',
    trigger: 'injection',
  ...
  },
  {
    ...
    category: 'medical_fact',
    timeOfDay: 'any',
    ru: 'Стресс от самого замера может временно повысить глюкозу. Если питомец нервничает, дай ему 5–10 минут успокоиться перед следующей попыткой.',
    en: 'Stress from the test itself can briefly raise glucose. If your pet is anxious, give them 5–10 minutes to calm down before trying again.',
  },
  {
    id: 'glu_w1_06',
    species: 'cat',
  ...
  },
  {
    ...
    category: 'practical',
    timeOfDay: 'any',
    ru: 'Записывай не только значение, но и контекст: питомец только поел, или натощак? Был ли стресс? Эти заметки помогут ветеринару.',
    en: 'Record not just the value, but the context: did your pet just eat, or is it fasting? Any stress? These notes help your vet.',
  },
  {
    id: 'glu_w2_05',
    species: 'cat',
...

  {
    ...
    category: 'medical_fact',
    timeOfDay: 'any',
    ru: 'К третьей неделе у тебя достаточно данных, чтобы видеть суточный ритм глюкозы питомца. Посмотри: в какое время суток показатели обычно выше?',
    en: "By week three you have enough data to see your pet's daily glucose rhythm. Look: at what time of day are the readings typically highest?",
  },
  {
    id: 'glu_w3_02',
    trigger: 'glucose',
  ...
  },
  {
    ...
    category: 'practical',
    timeOfDay: 'any',
    ru: 'Веди журнал наблюдений помимо чисел: аппетит, жажда, активность, настроение. Это помогает видеть связь между состоянием питомца и показателями глюкозы.',
    en: "Keep observational notes alongside the numbers: appetite, thirst, activity, mood. This helps you see the link between your pet's wellbeing and glucose readings.",
  },
  {
    id: 'glu_w4_06',
    trigger: 'glucose',
  ...
  },
  {
    ...
    category: 'support',
    timeOfDay: 'any',
    ru: 'Если питомец отказался от еды — это серьёзно при диабете. Не паникуй, но свяжись с ветеринаром в этот же день.',
    en: "If your pet refuses to eat — that's serious with diabetes. Don't panic, but contact your vet the same day.",
  },
  {
    id: 'feed_w1_04',
    trigger: 'feeding',
...

  {
    ...
    category: 'practical',
    timeOfDay: 'any',
    ru: 'Если питомец ест медленно — подожди, пока он съест большую часть порции, прежде чем делать укол. Цель — чтобы инсулин начал работать, когда глюкоза уже поднимается.',
    en: "If your pet eats slowly, wait until they've eaten most of their portion before giving the injection. The goal is for insulin to start working as glucose is rising.",
  },
  {
    id: 'feed_w2_02',
    trigger: 'feeding',
  ...
  },
  {
    ...
    category: 'support',
    timeOfDay: 'any',
    ru: 'Жёсткий режим кормления может быть неудобен для тебя тоже. Это нормально — ставить будильники, планировать день вокруг питомца. Ты делаешь это из любви.',
    en: "A strict feeding schedule can be inconvenient for you too. It's okay — setting alarms, planning your day around your pet. You're doing it out of love.",
  },
  {
    id: 'feed_w2_04',
    species: 'cat',
  ...
  },
  {
    ...
    category: 'medical_fact',
    timeOfDay: 'any',
    ru: 'Обильное питьё воды у питомца с диабетом — симптом высокой глюкозы. Если заметил, что питомец пьёт больше обычного — измерь глюкозу.',
    en: 'Excessive water drinking in a diabetic pet is a symptom of high glucose. If you notice your pet drinking more than usual, check the glucose.',
  },
  {
    id: 'feed_w2_06',
    species: 'cat',
  ...
  },
  {
    ...
    category: 'practical',
    timeOfDay: 'any',
    ru: 'На третьей неделе обрати внимание: меняется ли аппетит питомца в разное время суток? Это может помочь скорректировать расписание кормления.',
    en: "In week three, notice: does your pet's appetite vary at different times of day? This can help fine-tune the feeding schedule.",
  },
  {
    id: 'feed_w3_03',
    trigger: 'feeding',
  ...
  },
  {
    ...
    category: 'support',
    timeOfDay: 'any',
    ru: 'Питомец, который стабильно ест — это уже хороший знак. Аппетит у диабетических животных часто улучшается по мере стабилизации глюкозы.',
    en: 'A pet that eats consistently is already a good sign. Appetite in diabetic pets often improves as glucose stabilises.',
  },
...

  {
    ...
    category: 'medical_fact',
    timeOfDay: 'any',
    ru: 'К четвёртой неделе становится понятно, какой корм подходит питомцу лучше всего. Не торопись менять то, что работает.',
    en: "By week four you have a clearer picture of which food works best for your pet. Don't rush to change what's working.",
  },
  {
    id: 'feed_w4_02',
    trigger: 'feeding',
  ...
  },
  {
    ...
    category: 'support',
    timeOfDay: 'any',
    ru: 'Ты перестроил весь свой день вокруг потребностей питомца. Это большая жертва, которую видишь только ты — и он.',
    en: "You've restructured your entire day around your pet's needs. That's a big sacrifice that only you — and your pet — truly see.",
  },
  {
    id: 'feed_w4_04',
    trigger: 'feeding',
    ...
    category: 'practical',
    timeOfDay: 'any',
    ru: 'Если нужно поручить кормление другому человеку — дай ему конкретную инструкцию: какой корм, сколько граммов, во сколько часов, что делать, если питомец отказался.',
    en: 'If someone else needs to feed your pet, give them specific instructions: which food, how many grams, at what time, and what to do if they refuse to eat.',
  },
  {
    id: 'feed_w4_05',
    trigger: 'feeding',
  ...
  },
  {
    ...
    category: 'practical',
    timeOfDay: 'any',
    ru: 'Запиши рацион питомца и расписание кормлений — это пригодится, если придётся объяснять ситуацию новому ветеринару или при госпитализации.',
    en: "Write down your pet's diet and feeding schedule — it'll be useful if you need to explain the situation to a new vet or if your pet is hospitalised.",
  },
  {
    id: 'feed_w5_05',
    trigger: 'feeding',
  ...
  },
  {
    ...
    category: 'practical',
    timeOfDay: 'any',
    ru: 'Утро. Если инсулин хранится в холодильнике — достань его заранее, пусть согреется, пока ты кормишь питомца. Всё по порядку.',
    en: 'Morning. If the insulin is refrigerated, take it out ahead of time and let it warm while you feed your pet. Everything in order.',
  },
  {
    id: 'morn_w1_03',
    trigger: 'morning',
...
export const ACHIEVEMENT_HERO: AchievementContent = {
  ...
  congratulation: {
    ru: 'Ты прошёл 30 дней — 30 дней уколов, замеров, строгих расписаний и бессонных мыслей о том, всё ли ты делаешь правильно. Это требует не просто любви к питомцу, но и настоящей силы духа. Твой питомец не может сказать спасибо словами — но его аппетит, его желание играть, его тепло рядом с тобой — это и есть его благодарность. Ты справился с самым сложным первым месяцем. Продолжай в том же духе.',
    en: "You made it through 30 days — 30 days of injections, glucose checks, strict schedules, and quiet worries about whether you were doing everything right. It takes more than love for your pet; it takes real strength of character. Your pet can't say thank you in words — but their appetite, their willingness to play, their warmth beside you — that is their gratitude. You got through the hardest first month. Keep going.",
  },
  cardText: {
    ru: '30 дней рядом с питомцем. Каждый день.',
    en: "30 days by your pet's side. Every single day.",
  },
};
