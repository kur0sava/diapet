...
const ICON_MAP: Record<string, LucideIcon> = {
  // Account / cloud backup (AccountScreen) — these rendered as EMPTY space
  // before being mapped: Icon returns null for unknown names and the loose
  // `string & {}` IconName type hides typos from tsc.
  'cloud-outline': Cloud,
  cloud: Cloud,
  'cloud-upload-outline': CloudUpload,
  'cloud-download-outline': CloudDownload,
  'person-circle-outline': UserCircle,
  // No Google logo in lucide — AtSign reads as "account/identity" next to the
