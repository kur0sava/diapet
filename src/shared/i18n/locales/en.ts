export const en = {
  ...
  subscription: {
    ...
    prodamusDisclosure: 'Subscription auto-renews until cancelled. You can cancel anytime from your account.',
    checkStatus: 'Check subscription status',
    purchaseSuccess: 'Subscription activated! Welcome to DiaPet Pro.',
    noActiveSubscription: 'No active subscription found. If you recently paid, please wait a few minutes and try again.',
    ...
    comingSoonDesc: 'Subscription is being prepared. All PRO features are available for free right now!',
  ...
  hints: {
    ...
    aiComingSoonDesc: 'AI Assistant will be available with PRO subscription. Subscription is being prepared — stay tuned!',
  ...
  prediction: {
    ...
    comingSoonDesc: 'AI glucose analysis will be available with PRO subscription. Subscription is being prepared — stay tuned!',
    ...
    defaultDisclaimer: 'This analysis is generated by AI and is not a substitute for professional veterinary advice. Always consult your veterinarian before making any changes to your cat\'s treatment plan.',
  ...
  analyzer: {
    ...
    healthScore: 'Health',
    disclaimer: 'This analysis is for informational purposes only. All treatment decisions should be made with your veterinarian.',
