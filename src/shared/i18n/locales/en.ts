export const en = {
  ...
  subscription: {
    ...
    features: {
      ...
      aiAssistantDesc: "Chat with AI about your cat's diabetes",
  ...
  prediction: {
    ...
    defaultDisclaimer:
      "This analysis is generated by AI and is not a substitute for professional veterinary advice. Always consult your veterinarian before making any changes to your cat's treatment plan.",
