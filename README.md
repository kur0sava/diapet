# DiaPet -- Управление диабетом у кошек и собак

Мобильное приложение для Android для управления сахарным диабетом у кошек и собак.
...
- Облачная резервная копия — опциональная (Google Sign-In + Firestore), по умолчанию всё локально
- Поддержка нескольких питомцев (кошки и собаки)
- Экспорт PDF реализован (expo-print)
